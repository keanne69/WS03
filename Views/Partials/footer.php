            ...
            <div class="footer-grid">
                <div class="footer-brand-block">
                    <a href="/WS03/Public/" class="footer-brand">
                        <span class="footer-brand-mark">B</span>
                        <span>BenchzCareers</span>
                    </a>

                    <p>
                        BenchzCareers helps job seekers discover better opportunities and helps employers
                ...
                <div class="footer-links-block">
                    ...
                    <ul>
                        <li><a href="/WS03/Public/listings">Available Roles</a></li>
                        <li><a href="/WS03/Public/listings/create">Employer Portal</a></li>
                    </ul>
                </div>
            </div>

            <div class="footer-bottom">
                <p>&copy; <?= date('Y') ?> BenchzCareers. Built for smarter career discovery.</p>
